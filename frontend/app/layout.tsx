...
import { PresetProvider } from '@/contexts/PresetContext'; // ✅ NEW: Import PresetProvider
...
export default function RootLayout({
  ...
  return (
    <html lang="en">
      ...
      >
        <AuthProvider>
          <PresetProvider> {/* ✅ NEW: Wrap with PresetProvider */}
            <ShopProvider>
          ...
          </PresetProvider> {/* ✅ NEW: Close PresetProvider */}
        </AuthProvider>
      </body>
    </html>
  );
